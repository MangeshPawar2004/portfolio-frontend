...
export default function Contact() {
  ...
  return (
    <section id="contact" className="section border-t border-[#242424]">
        ...
        <div className="mt-12 grid lg:grid-cols-5 gap-10">
          ...
          <FadeIn direction="right" className="lg:col-span-2 space-y-4">
            ...
            {CONTACT_INFO.map(({ icon: Icon, label, value, href }) => (
              <div key={label}
                className="flex items-start gap-4 p-4 rounded-xl bg-[#111111]
            ...
            {/* Availability note */}
            <div className="p-4 rounded-xl bg-[#0d2e1f] border border-[#1a4d35]">
          ...
          <FadeIn direction="left" delay={0.1} className="lg:col-span-3">
            <div className="p-8 rounded-2xl bg-[#111111] border border-[#242424]">
